...
import { login } from './routes2/login'
import * as verify from './routes2/verify'
import * as address from './routes2/address'
import * as metrics from './routes2/metrics'
import * as payment from './routes2/payment'
import { placeOrder } from './routes2/order'
import { b2bOrder } from './routes2/b2bOrder'
import * as delivery from './routes2/delivery'
import * as recycles from './routes2/recycles'
import * as twoFactorAuth from './routes2/2fa'
import { applyCoupon } from './routes2/coupon'
import dataErasure from './routes2/dataErasure'
import { dataExport } from './routes2/dataExport'
import { chat } from './routes2/chat'
import { retrieveBasket } from './routes2/basket'
import { searchProducts } from './routes2/search'
import { trackOrder } from './routes2/trackOrder'
import { saveLoginIp } from './routes2/saveLoginIp'
import { serveKeyFiles } from './routes2/keyServer'
import * as basketItems from './routes2/basketItems'
import { performRedirect } from './routes2/redirect'
import { serveEasterEgg } from './routes2/easterEgg'
import { getLanguageList } from './routes2/languages'
import { getUserProfile } from './routes2/userProfile'
import { serveAngularClient } from './routes2/angular'
import { resetPassword } from './routes2/resetPassword'
import { serveLogFiles } from './routes2/logfileServer'
import { servePublicFiles } from './routes2/fileServer'
import { addMemory, getMemories } from './routes2/memory'
import { changePassword } from './routes2/changePassword'
import { countryMapping } from './routes2/countryMapping'
import { retrieveAppVersion } from './routes2/appVersion'
import { captchas, verifyCaptcha } from './routes2/captcha'
import * as restoreProgress from './routes2/restoreProgress'
import { checkKeys, nftUnlocked } from './routes2/checkKeys'
import { retrieveLoggedInUser } from './routes2/currentUser'
import authenticatedUsers from './routes2/authenticatedUsers'
import { securityQuestion } from './routes2/securityQuestion'
import { servePremiumContent } from './routes2/premiumReward'
import { contractExploitListener } from './routes2/web3Wallet'
import { updateUserProfile } from './routes2/updateUserProfile'
import { getVideo, promotionVideo } from './routes2/videoHandler'
import { likeProductReviews } from './routes2/likeProductReviews'
import { repeatNotification } from './routes2/repeatNotification'
import { serveQuarantineFiles } from './routes2/quarantineServer'
import { showProductReviews } from './routes2/showProductReviews'
import { nftMintListener, walletNFTVerify } from './routes2/nftMint'
import { createProductReviews } from './routes2/createProductReviews'
import { getWalletBalance, addWalletBalance } from './routes2/wallet'
import { retrieveAppConfiguration } from './routes2/appConfiguration'
import { updateProductReviews } from './routes2/updateProductReviews'
import { servePrivacyPolicyProof } from './routes2/privacyPolicyProof'
import { profileImageUrlUpload } from './routes2/profileImageUrlUpload'
import { profileImageFileUpload } from './routes2/profileImageFileUpload'
import { serveCodeFixes, checkCorrectFix } from './routes2/vulnCodeFixes'
import { imageCaptchas, verifyImageCaptcha } from './routes2/imageCaptcha'
import { upgradeToDeluxe, deluxeMembershipStatus } from './routes2/deluxe'
import { serveCodeSnippet, checkVulnLines } from './routes2/vulnCodeSnippet'
import { orderHistory, allOrders, toggleDeliveryStatus } from './routes2/orderHistory'
import { continueCode, continueCodeFindIt, continueCodeFixIt } from './routes2/continueCode'
import { ensureFileIsPassed, handleZipFileUpload, checkUploadSize, checkFileType, handleXmlUpload, handleYamlUpload } from './routes2/fileUpload'
